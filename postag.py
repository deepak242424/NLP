...
def get_POS_suggestions(tagged_corpus, incorrectwords, suggestions, simplifiedTags, output_likelihoods):
    sum_count_dict = {}
...
print get_POS_suggestions(tagged_corpus, incorrectwords, suggestions, simplifiedTags, output_likelihoods)